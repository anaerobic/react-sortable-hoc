!(function(e, t) {
...
})(this, function(e, a, i, s) {
  'use strict';
  var l = 'default' in a ? a.default : a;
  function t(e, t) {
  ...
  function Z(r) {
    ...
    return (
          ...
          p(n, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return a.createElement(r, c({ref: e}, this.props));
              },
            },
          ]),
          n
      ...
      S(e, 'displayName', K('sortableHandle', r)),
      t
    );
  }
  function ee(e) {
  ...
  var ne = {
    ...
    re = {lift: [q], drop: [q], cancel: [Y], up: [V, F], down: [$, z]},
    oe = {
      axis: 'y',
      disableAutoscroll: !1,
      distance: 0,
      ...
      shouldCancelStart: function(e) {
        return (
          -1 !==
            [J.Input, J.Textarea, J.Select, J.Option, J.Button].indexOf(
              e.target.tagName,
            ) ||
  ...
  function ce(t) {
    ...
    return (
      (n = e = (function(e) {
        ...
        function r(e) {
          ...
          return (
            ...
            (R = n.call(this, e)),
            S(y(R), 'state', {}),
            S(y(R), 'handleStart', function(e) {
              var t = R.props,
                n = t.distance,
                r = t.shouldCancelStart;
              if (2 !== e.button && !r(e)) {
                (R.touched = !0), (R.position = _(e));
                var o,
            ...
            S(y(R), 'nodeIsChild', function(e) {
              return e.sortableInfo.manager === R.manager;
            }),
            S(y(R), 'handleMove', function(e) {
              var t = R.props,
                n = t.distance,
                r = t.pressThreshold;
              if (
                          ...
                          var e,
                            ...
                            u =
                              ...
                              (r = window.getComputedStyle(n)).display
                                ? {x: H(r.gridColumnGap), y: H(r.gridRowGap)}
                                : {x: 0, y: 0}),
            ...
            S(y(R), 'handleSortMove', function(e) {
            ...
            S(y(R), 'handleSortEnd', function(e) {
              var t = R.props,
              ...
              R.listenerNode &&
                ...
                n &&
                  R.sortableGhost &&
                  N(R.sortableGhost, {opacity: '', visibility: ''});
            ...
            S(y(R), 'onAutoScroll', function(e) {
              (R.translate.x += e.left),
                (R.translate.y += e.top),
                R.animateNodes();
            }),
            S(y(R), 'handleKeyDown', function(e) {
              var t = e.keyCode,
                n = R.props,
            ...
            S(y(R), 'keyDrop', function(e) {
              R.handleSortEnd(e),
                R.initialFocusedNode && R.initialFocusedNode.focus();
            }),
            S(y(R), 'handleKeyEnd', function(e) {
              R.manager.active && R.keyDrop(e);
            }),
            S(y(R), 'isValidSortingTarget', function(e) {
        ...
        return (
          p(r, [
                ...
                if (
                  ...
                  var d = (function(e) {
                      ...
                      var i = b(o, 2),
                        ...
                        s = i[1];
                      return [
                        U({height: t, lockOffset: a, width: n}),
                        U({height: t, lockOffset: s, width: n}),
                      ];
              ...
              value: function() {
                ...
                for (var f = 0, d = a.length; f < d; f++) {
                  var h = a[f].node,
                    ...
                    S = a[f].edgeOffset;
                  S ||
                    ((S = B(h, this.container)),
                    (a[f].edgeOffset = S),
                    c && (a[f].boundingClientRect = G(h, o)));
                  var O = f < a.length - 1 && a[f + 1],
                    C = 0 < f && a[f - 1];
                  O &&
                    !O.edgeOffset &&
                    ((O.edgeOffset = B(O.node, this.container)),
                    c && (O.boundingClientRect = G(O.node, o))),
                    p !== this.index
                      ? (t && P(h, t),
                        this.axis.x
                          ? this.axis.y
            ...
            },
            {
              ...
              value: function() {
                var e = o.withRef ? 'wrappedInstance' : null;
                return a.createElement(t, c({ref: e}, R(this.props, ie)));
              },
            },
            {
              key: 'helperContainer',
      ...
      S(e, 'displayName', K('sortableList', t)),
      S(e, 'defaultProps', oe),
      S(e, 'propTypes', ne),
      S(e, 'childContextTypes', {manager: i.object.isRequired}),
      n
    );
  }
  function ue(r) {
  ...
  function he(t) {
    ...
    return (
        ...
        return (
          p(i, [
            ...
            },
            {
              key: 'render',
              value: function() {
                var e = r.withRef ? 'wrappedInstance' : this.wrapper;
                return l.createElement(t, c({ref: e}, R(this.props, de)));
              },
            },
          ]),
          i
      ...
      S(e, 'displayName', K('sortableElement', t)),
      S(e, 'contextTypes', {manager: i.object.isRequired}),
      S(e, 'propTypes', fe),
      S(e, 'defaultProps', {collection: 0}),
      n
    );
  }
  (e.SortableContainer = ce),
    (e.SortableElement = he),
    (e.SortableHandle = Z),
